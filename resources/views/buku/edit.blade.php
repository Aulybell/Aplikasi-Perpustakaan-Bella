                ...
                <form wire:submit.prevent="store">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" wire:model="sinopsis"
                            id="sinopsis" rows="3">{{ @old('sinopsis') }}</textarea>
                            @error('sinopsis')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <!-- Button -->
                    <button type="button" wire:click="update({{ $this->id }})" class="btn btn-primary">
                        Simpan
                    </button>
